  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 bg-background">
      <div className="hidden md:flex flex-col justify-between p-10 text-primary-foreground" style={{ background: "linear-gradient(135deg, hsl(220 90% 40%), hsl(220 90% 25%))" }}>
        ...
        <div>
          <div className="text-4xl font-bold leading-tight">AI-native ERP for Indian SMEs</div>
        ...
        <div className="text-xs opacity-70">© {new Date().getFullYear()} ProBuddy ERP for SMEs</div>
      </div>
